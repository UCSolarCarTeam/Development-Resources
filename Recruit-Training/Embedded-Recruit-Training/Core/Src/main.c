...
int main(void)
{
  ...
  /* USER CODE BEGIN RTOS_THREADS */
    ...
    osThreadDef(greenLedTask, greenLedToggleTask, osPriorityNormal, 1, configMINIMAL_STACK_SIZE);
    greenLedToggleTaskHandle = osThreadCreate(osThread(greenLedTask), NULL);
    /* add threads, ... */
